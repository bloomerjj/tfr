                ...
                self.showModal = function(options) {
                    ...
                    getTemplate(options.template, options.templateUrl)
                        .then(function(template) {
                            ...
                            // Attempting to key scroll event from bubbling out and causing background scrolling.
                            modalElement.find('*').on('touchmove touchstart touchend', function(e) {
                                e.stopPropagation();
                            });
                            modalElement.on('touchmove touchstart touchend', function(e) {
                                e.stopPropagation();
                            });



                            // An attempt to stop weird background scrolling behavior for the modal backgroune
                            $('.modal__outer').on('touchmove touchstart touchend', function(e) {
                                e.preventDefault();
                                e.stopPropagation();
                            });
                            // Initial resize
